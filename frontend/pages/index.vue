<template>
  <div class="flex-1 w-full h-full flex items-center justify-center p-4 text-gray-700 mb-24">
    <div
        class=" overflow-hidden bg-black bg-opacity-10 border border-primary-800 border-opacity-50 text-center rounded-lg">
      <div class="px-8 pb-8 pt-4"><h1 class="text-2xl font-bold mb-4 text-primary-800">Тестовое задание</h1>
        <p class="text-sm text-right text-green-500">* Зеленым цветом отмечены выполненные задания</p>
        <pre class="text-primary-600 text-left">
              Сервис уведомлений
          ...
          Спроектировать и разработать сервис, который по заданным правилам запускает рассылку по списку клиентов.
            ...
            <span class="font-bold text-green-500">Сущность "рассылка" имеет атрибуты:
          ...
          тестовым заданием.</span>

            Дополнительные задания
          Опциональные пункты, выполнение любого количества из приведённого списка повышают ваши шансы на положительное
          решение о приёме
          <span class="font-bold text-green-500">1. организовать тестирование написанного кода</span>
          2. обеспечить автоматическую сборку/тестирование с помощью GitLab CI
          <span class="font-bold text-green-500">3. подготовить docker-compose для запуска всех сервисов проекта одной командой</span>
          ...
          <span class="font-bold text-green-500">5. сделать так, чтобы по адресу /docs/ открывалась страница со Swagger UI и в нём отображалось описание
            разработанного API. Пример: https://petstore.swagger.io</span>
          <span class="font-bold text-green-500">6. реализовать администраторский Web UI для управления рассылками и получения статистики по отправленным
          сообщениям</span>
          ...
          <span class="font-bold text-green-500">12. обеспечить подробное логирование на всех этапах обработки запросов, чтобы при эксплуатации была возможность
