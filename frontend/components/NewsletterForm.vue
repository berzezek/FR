<template>
  ...
  <form @submit.prevent="props.newsletterForm.tag === 'add' ? newsletterAdd : newsletterEdit">
    <h2 class="text-gray-500 text-center mb-5">{{ props.newsletterForm.title }}</h2>
    <div class="grid md:grid-cols-2 md:gap-6">
      <div class="relative z-0 mb-6 w-full group">
        <input type="datetime-local" name="floating-start-launch-date"
        ...
        <label for="floating-end-launch-date"
               class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Начало рассылки</label>
      </div>
      <div class="relative z-0 mb-6 w-full group">
        <input type="datetime-local" name="floating-end-launch-date" id="floating-end-launch-date"
               v-model="props.newsletterData.end_launch_date"
               class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-gray-400 dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
               placeholder=" " required/>
        <label for="floating-end-launch-date"
               class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Окончание рассылки</label>
      </div>
    </div>
